 ...
 *
 * `viewToggle` is the Usage/Limits switch owned by {@link UsagePage}; it is
 * passed in so both views render it in the same header row instead of
 * duplicating its markup.
 */
export function UsageLimitsContent({ viewToggle }: { readonly viewToggle: ReactNode }) {
